    ...
    <div className={`min-h-screen flex items-center justify-center p-4 transition-colors ${isDarkMode ? 'bg-slate-950' : 'bg-slate-50'}`}>
      <div className="max-w-xl w-full text-center">
        <div className="mb-12 relative">
          ...
          <p className="text-indigo-600 dark:text-indigo-400 text-sm font-black uppercase tracking-[0.4em]">
        ...
        <div className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[3rem] p-10 md:p-14 shadow-2xl transition-all duration-500 ${isInitializing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'}`}>
          <div className="mb-10 text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-xs mx-auto font-medium">
              Initialize the engine to begin your journey into deep conceptual mastery.
            </p>
          </div>
          ...
          <button
            ...
            className={`group relative w-full overflow-hidden rounded-2xl bg-indigo-600 py-4 font-black uppercase tracking-widest text-white shadow-xl transition-all hover:bg-indigo-700 active:scale-[0.98] ${isInitializing ? 'cursor-wait' : ''}`}
          >
          ...
          <div className="mt-12 flex flex-col items-center space-y-6">
            <div className="flex items-center w-full px-4">
              ...
              <span className="px-4 text-[9px] font-black text-slate-300 dark:text-slate-600 uppercase tracking-widest">System Protocols</span>
              <div className="flex-1 h-px bg-slate-100 dark:bg-slate-800"></div>
            </div>
        ...
        <p className="mt-12 text-[10px] text-slate-400 dark:text-slate-600 font-bold uppercase tracking-[0.3em] animate-pulse">
